...
The usage for a fee component is based on [**Usage Drivers**](/documentation/billing/components/usage-driver) — which define how consumption is measured (e.g., number of deliveries, weight, distance).
